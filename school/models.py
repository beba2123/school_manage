...
class Teacher_subject(models.Model):
    teacherId = models.ForeignKey(Family_type, on_delete=models.CASCADE(), blank=False)
    subjectId = models.ForeignKey(Family_type, on_delete=models.CASCADE(), blank=False)
